      ...
      >
        ...
        >
          <a
            ...
            id="fire-popup"
          >
            <i class="large calendar plus icon"></i> Ajouter événement
          </a>
        </div>
      </div>
      <!--TABLE-->
        ...
        <div class="form">
          ...
          <form>
            ...
            <input
              id="input-map"
              class="form-control"
              placeholder="Rechercher un adresse..."
            />
          </form>
        </div>
  ...
  methods: {
    ...
    geolocation(lat, lon) {
      ...
      function addMarker(suggestion) {
        ...
        marker.bindPopup(
          "<h4>Nouvelle adresse de votre événement</h4><br><span>Les modifications seront prises en compte lorsque vous moodifiez l'événement'.</span>"
        );
        marker.addTo(map);
        markers.push(marker);
      }
