      ...
      <div id="three-column" class="container">
        ...
        <div class="container ui stackable three column grid">
          ...
          <div class="boxB column">
            ...
            <p>
              Visualiser en un seul clic votre participation aux événements auxquels vous avez été invité !
            </p>
            <a @click="invitation" class="button button-alt">Mes participations à évenements</a>
          </div>
